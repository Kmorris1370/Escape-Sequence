...
public class RulesScreen extends javax.swing.JFrame {
    ...
    public RulesScreen(Source source, String playerName) {
        ...
        backgroundLabel.setIcon(ResourceLoader.loadImageScaled("/assets/pictures/TitleScreen.jpg",1200,700));
        backButton.setIcon(ResourceLoader.loadImageScaled("/assets/pictures/BackArrow.png",60,60));
        tutorialButton.setIcon(ResourceLoader.loadImageScaled("/assets/pictures/Video.png",60,60)); 
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 20, 870, 550));
        ...
        jPanel1.add(tutorialButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1100, 10, 60, 60));
        ...
        jPanel1.add(tutorialLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 80, 150, 20));
        ...
        jPanel1.add(backButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 60, 60));
